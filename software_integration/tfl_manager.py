...
from phaseI_light_spots_attention.run_attention import find_tfl_lights
from phaseIII_estimated_distance_from_tfls.SFM import calc_TFL_dist
from phaseII_train_tfl_net.build_dataset import crop
...
class TFLMan:
    ...
    def find_tfls(self):
        ...
        loaded_model = load_model("../phaseII_train_tfl_net/model.h5")
